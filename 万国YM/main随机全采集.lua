...
t['打野-正在行军-返回']={0xdb8100, "0|0|0xdb8100,6|2|0xfefefd,7|14|0xb45d00",90,1268,167,1322,458}
t['打野-正在行军-返回-iphone6']={0xc97612, "0|0|0xc97612,5|5|0xfdfaf7,5|10|0xb25c01",90,1288,237,1311,458}
...
--    			    end
				...
				if d("采矿-行军")  then
    			    ...
    			    if d("采矿-行军") or d('采矿-行军2') then
    			        if d('采集-行军-有兵') or d('采集-行军-有兵2') then
    			            d("采矿-行军",true)
    			            d('采矿-行军2',true)
                        else
                            _UI.采集.key = false
...
function _神秘商店()
    ...
    while i < 5 and d('任务-神秘商人界面') do
        ...
        for ii = 1,2 do
            for i=0,3 do
                t['商店购买-玉米']={0x3f930e, "0|0|0x3f930e,2|-11|0xffeb39,-6|-2|0x5caf0d,-6|6|0x266d0a,5|7|0xfea400",90,373,212,1132,674}
                t['商店购买-木材']={0xd18e5d, "0|0|0xd18e5d,-1|-9|0xe9a666,11|-12|0x81330c,9|-8|0x772604,11|4|0xffa500",90,373,212,1132,674}
                local i = 0
                while (  d('商店购买-木材',true,1,2) or d('商店购买-玉米',true,1,2) ) and i < 4 do
                    i=i+1
                end
            end
